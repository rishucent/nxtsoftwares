...
<?php if (is_404()) : ?>
    <div class="page-header">
        <h1 class="page-title"><?php esc_html_e('Not Found', 'mynx'); ?></h1>
    </div>
<?php elseif (is_category()): ?>
    <div class="archive-header">
        <h1 class="archive-title"><?php print single_cat_title('', false); ?></h1>
        <div class="archive-subtitle"><?php print esc_html__('Category archives', 'mynx'); ?></div>
...
<?php elseif (is_tag()): ?>
    <div class="archive-header">
        ...
        <div class="archive-subtitle"><?php print esc_html__('Tag archives', 'mynx'); ?></div>
    ...
    <div class="archive-header">
        <h1 class="archive-title"><?php
            if (is_day()) :
                print get_the_date();
            elseif (is_month()) :
                print get_the_date(_x('F Y', 'monthly archives date format', 'mynx'));
            elseif (is_year()) :
                print get_the_date(_x('Y', 'yearly archives date format', 'mynx'));
            endif;
            ?></h1>
        <div class="archive-subtitle"><?php
            if (is_day()) :
                esc_html_e('Daily Archives', 'mynx');
            elseif (is_month()) :
                esc_html_e('Monthly Archives', 'mynx');
            elseif (is_year()) :
                esc_html_e('Yearly Archives', 'mynx');
            endif;
            ?></div>
    </div><!-- .archive-header -->
...
<?php elseif (is_search()): ?>
    <div class="page-header">
        <h1 class="page-title"><?php print esc_html__('Search Results for', 'mynx'); ?></h1>
